...
namespace HHSocialNetwork_Project.Migrations
{
    ...
    [Migration("20240130153937_update_table_usermessage")]
    partial class update_table_usermessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clone_Main_Project_0710.Models.UserMessage", b =>
                {
            ...
            modelBuilder.Entity("Clone_Main_Project_0710.Models.UserMessage", b =>
                {
                    b.HasOne("Clone_Main_Project_0710.Models.User", "SourceUser")
                        .WithMany("SourceUserMessages")
                        .HasForeignKey("SourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clone_Main_Project_0710.Models.User", "TargetUser")
                        .WithMany("TargetUserMessages")
                        .HasForeignKey("TargetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Clone_Main_Project_0710.Models.User", b =>
                {
                    ...
                    b.Navigation("SourceUserMessages");
                    ...
                    b.Navigation("TargetUserMessages");
